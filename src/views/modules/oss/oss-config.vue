  ...
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="120px">
      ...
      <template v-else-if="dataForm.type === 4">
        <el-form-item label="域名">
          <el-input v-model="dataForm.fastdfsUrl" placeholder="fastdfs"></el-input>
        </el-form-item>
        <el-form-item label="超时时间">
          <el-input v-model="dataForm.connectTimeout" placeholder="不设置默认为3000"></el-input>
        </el-form-item>
        <el-form-item label="连接超时时间">
          <el-input v-model="dataForm.networkTimeout" placeholder="不设置默认为3000"></el-input>
        </el-form-item>
        <el-form-item label="字符集">
          <el-input v-model="dataForm.charset" placeholder="默认utf-8"></el-input>
        </el-form-item>
        <el-form-item label="tracker端口">
          <el-input v-model="dataForm.trackerHttpPort" placeholder="tracker端口"></el-input>
        </el-form-item>
        <el-form-item label="tracker地址">
          <el-input v-model="dataForm.trackerServer" placeholder="tracker地址"></el-input>
        </el-form-item>
        <el-form-item label="是否开启token">
          <el-input v-model="dataForm.antiStealToken" placeholder="0?1"></el-input>
        </el-form-item>
        <el-form-item label="token">
          <el-input v-model="dataForm.secretKey" placeholder="token"></el-input>
        </el-form-item>
      </template>
    </el-form>
    ...
    methods: {
      init (id) {
        ...
        this.$http({
          ...
          this.dataForm = data && data.code === 200 ? data.data : []
        })
      },
      // 表单提交
      dataFormSubmit () {
